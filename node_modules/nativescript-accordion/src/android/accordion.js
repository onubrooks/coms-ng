...
var AccordionListAdapter = (function (_super) {
    ...
    AccordionListAdapter.prototype.getGroupView = function (groupPosition, isExpanded, convertView, parent) {
        ...
        var _args = notifyForHeaderOrFooterAtIndex(owner, view ? view._nativeView : null, view, exports.HEADERLOADING, groupPosition);
        ...
        if (owner.headerColor) {
            header.android.setBackgroundColor(new color_1.Color(owner.headerColor).android);
        }
        if (owner.headerTextColor) {
            header.android.setTextColor(new color_1.Color(owner.headerTextColor).android);
        }
    ...
    AccordionListAdapter.prototype.getChildView = function (groupPosition, childPosition, isLastChild, convertView, parent) {
        ...
        var _args = notifyForItemAtIndex(owner, view ? view._nativeView : null, view, exports.ITEMSLOADING, groupPosition, childPosition);
        view = view || _args.view;
