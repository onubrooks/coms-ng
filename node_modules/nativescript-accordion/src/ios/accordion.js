...
var Accordion = (function (_super) {
    ...
    function Accordion() {
        ...
        _this._ios.registerClassForCellReuseIdentifier(AccordionCell.class(), AccordionViewCellReuseIdentifier);
        _this.ios.registerNibForHeaderFooterViewReuseIdentifier(UINib.nibWithNibNameBundle("AccordionHeaderView", null), AccordionHeaderViewReuseIdentifier);
        _this.ios.registerNibForHeaderFooterViewReuseIdentifier(UINib.nibWithNibNameBundle("AccordionFooterView", null), AccordionFooterViewReuseIdentifier);
        ...
        _this._dataSource = AccordionDataSource.initWithOwner(new WeakRef(_this));
        ...
        _this._indexSet = NSMutableIndexSet.alloc().init();
        return _this;
    }
            ...
            if (has && !selected) {
                ...
                if (view) {
                    ...
                    if (!types.isNullOrUndefined(data)) {
                        view.bindingContext = new observable_1.Observable(data);
                    }
                    if (!view.parent) {
                        owner._addView(view);
                    }
